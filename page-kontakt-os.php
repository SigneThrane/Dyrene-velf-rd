...
<body>
        ...
        <div class="row">
        <div class="col-sm-4">
            <p>Du er mere end velkommen til at kontakte os vedrørende spørgsmål, 
               <br>  forespørgsler, donationer, anmeldelser, medlemskab m.m. 
                    <br>
...
Vi kan kontaktes via mail alle ugens dage, og vil vende tilbage indenfor 48 timer</p>
        ...
        <div style="width:100%; max-width:100%; margin:0px; bottom: 0px; transform: rotate(180deg);"><svg id="mymainsvgelm" data-name="Layer 1" 
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" class="" style="width: calc(130% + 1.3px); height: 106px;">
        <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,
        3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" style="fill: rgb(242, 232, 219);"></path></svg></div>
                <div class="sponsor">
                    <br><br><br>
                   ...
                   <br> <br><br>
                    <div class="row">
                      ...
                      <img  width="90%" src="<?php the_field('sponsor_1'); ?>" alt="Angelical affairs" />
                        </div>

                        <div class="col-md-4">
                        <img  width="90%" src="<?php the_field('sponsor_2'); ?>" alt="katte rådgier" />
                        </div>

                        <div class="col-md-4">
                        <img  width="90%" src="<?php the_field('sponsor_3'); ?>" alt="Enghave hund" />
