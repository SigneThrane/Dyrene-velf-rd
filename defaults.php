...
function bravada_get_option_defaults() {
	...
	// Colors
    "theme_sitebackground" 			=> "#5D7E4B",
    "theme_sitetext" 				=> "#F7F7F6",
    "theme_titletext" 				=> "#F6C883",
    "theme_headingstext" 			=> "#F6C883",
    "theme_contentbackground"		=> "#F2E8DB",
    "theme_primarybackground"		=> "#5D7E4B",
    "theme_secondarybackground"		=> "#F19B38",
    "theme_accent1" 				=> "#F6C883",
    "theme_accent2" 				=> "#36482C",
